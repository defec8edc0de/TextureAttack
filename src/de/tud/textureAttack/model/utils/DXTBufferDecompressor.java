...
public class DXTBufferDecompressor extends BufferDecompressor {
	...
	public DXTBufferDecompressor(byte[] compressedData, int width, int height,
		...
		this(ByteBuffer.wrap(compressedData), new Dimension(width, height),
				compressionType);
	}
	...
	public DXTBufferDecompressor(final ByteBuffer compressedBuffer,
		...
		this.uncompressedBuffer = squishDecompressBuffer(compressedBuffer,
				dimension.width, dimension.height, type);
	...
	public static byte[] squishDecompressToArray(final byte[] compressedData,
		...
		if (type != null) {
			byte[] decompressedData = Squish.decompressImage(null, width,
					height, compressedData, type);
	...
	public static ByteBuffer squishDecompress(final byte[] compressedData,
		...
		return ByteBuffer.wrap(squishDecompressToArray(compressedData, width,
				height, type));
	}
